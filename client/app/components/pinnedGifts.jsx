...
// var ProductGroupRow = React.createClass({
//   render: function() {
//       return (<tr><th colSpan="2">{this.props.productgroup}</th></tr>);
//   }
// });
  ...
  render: function() {
      return (
          <tr className="book-info">
            <td className="book-price"><img src={this.props.book.Price}/></td>
            <td className="book-img"><img src={this.props.book.SmallImage.URL}/></td>
            <td className="book-author">{this.props.book.ItemAttributes.Author}</td>
...
var GiftTable = React.createClass({
  render: function() {
      ...
      this.props.books.forEach(function(book) {
          // rows.push(<ProductGroupRow productgroup={book.productgroup} key={book.productgroup} />);
...
var PinnedGiftTable = React.createClass({
  render: function() {
      console.log(this.props)
      return (
          <div className = "pinnedgifts">
              <UserHeader user={this.props.user}/>
              <SearchBar />
              <GiftTable books={this.props.books} />
          </div>
      );
  }
});
...
var USER_DATA = {
  ...
  "birthday": "01/26/1985",
  "id": "108923832428478`",
  "photo": "https://scontent.fsjc1-2.fna.fbcdn.net/hphotos-xap1/v/t1.0-9/p206x206/10406710_10102545751565304_7358105488241649435_n.jpg?oh=7b895fa5c22f4998439cee4c654d5be2&oe=567F8FEB"
};

React.render(<PinnedGiftTable books={BOOKS} user = {USER_DATA} />, document.getElementById('pinned-gifts'));
